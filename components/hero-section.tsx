    ...
    <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-6 inline-block px-4 py-2 bg-secondary rounded-full border border-primary/20">
          <span className="text-sm font-medium text-primary">Invest in Agriculture, Earn Profit</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button size="lg" asChild className="bg-primary hover:bg-primary/90 text-lg">
